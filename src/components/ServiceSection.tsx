    ...
    () => ({
      ...
      latest: [
        ...
        },
        {
          ...
          isVerified: true,
          location: "National",
          website: "https://kibank.cm",
        },
        {
          id: "10",
          name: "Nervtek",
          description: {
            en: "Innovative software solutions for businesses.",
            fr: "Solutions logicielles innovantes pour les entreprises.",
            pid: "New new software solutions for business people.",
          },
          image: "nervtek.png",
          rating: 4.8,
          reviewCount: 320,
