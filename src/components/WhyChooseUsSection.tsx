...
const WhyChooseUsSection = () => {
  ...
  const content = {
    ...
    fr: {
      ...
      description:
        "Votre plateforme centrale pour découvrir et accéder aux meilleurs services numériques que le Cameroun a à offrir. Nous nous engageons à autonomiser notre communauté en connectant les utilisateurs avec des entreprises locales innovantes.",
      points: [
        {
          icon: <Target className="w-10 h-10 text-blue-600 mb-4" />,
    ...
    pid: {
      ...
      description:
        "Your main place for discover and access the best digital services wey Cameroon get for offer. We dey committed for empower our community by connecting users with local businesses wey get sense.",
      points: [
        {
          icon: <Target className="w-10 h-10 text-blue-600 mb-4" />,
